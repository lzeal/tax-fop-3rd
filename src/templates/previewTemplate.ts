...
<div class="page" id="page">
      ...
      <td class="text-left">
        ...
        <table class="table-inner" style="padding:0 2px; margin-top:4px; width:95%; margin-left:auto; margin-right:auto">
          <tr>
            ...
            <td class="" style="width: 50px;"> {{HZY}}</td>
      ...
      <td class="text-left">
        ...
        <table class="table-inner" style="padding:0 2px; margin-top:4px; width:95%; margin-left:auto; margin-right:auto">
          <tr>
            ...
            <td class="" style="width: 10px; border: 0;"> &nbsp;</td>
            <td class="" style="width: 50px;"> {{HZYP}}</td>
            <td class="" style="border: 0;"> року</td>
          </tr>
          <tr>
            <td style="border: 0;" class="text-small" colspan="8">(необхідне позначити)</td>
  ...
  <table class="table-main">
    <tr>
      ...
      <td class="borderred"> Реєстраційний номер облікової картки платника податків або серія (за наявності) та номер паспорта</td>
  ...
  <table class="table-main borderred">
    ...
    <tr>
      ...
      <td class="">платника податку, що подає цю податкову декларацію за останній податковий (звітний) період, на який припадає дата державної реєстрації припинення</td>
    </tr>
    <tr>
      <td class="borderred">8.2</td>
      <td class="">{{M082}}</td>
      <td class="">платника податку, що подає цю податкову декларацію за останній податковий (звітний) період, в якому здійснено перехід на сплату інших податків та зборів</td>
    </tr>
  </table>
  ...
  <table class="table-main borderred">
    ...
    <tr>
      ...
      <td class="" colspan="3">Вид підприємницької діяльності у звітному періоді:</td>
    </tr>
  ...
  <table class="table-main borderred">
    <tr class="borderred">
      ...
      <td class=" text-center">Обсяг (грн, коп)</td>
    </tr>
    <tr>
    ...
    <tr>
      <td class=" col75" colspan="3">Обсяг доходу, що оподаткований за ставкою 15 відсотків (згідно з пунктом 293.4 статті 293 глави 1 розділу XIV Податкового кодексу України), у звітному (податковому) періоді</td>
  ...
  <table class="table-main borderred">
    ...
    <tr>
      <td class=" col75" colspan="3">Позитивне значення різниці між сумою загального мінімального податкового зобов'язання та загальною сумою сплачених податків, зборів, платежів та витрат на оренду земельних ділянок (рядок 04 графи 3 розділу ІІ додатка 2 цієї податкової декларації)</td>
      <td class=" text-center text-big">14.2</td>
      <td class=" text-center">{{R0142G3}}</td>
    </tr>
    <tr class="borderred">
      <td class=" col75 text-big" colspan="3">Загальна сума єдиного податку, яка підлягає нарахуванню та сплаті в бюджет за підсумками поточного звітного (податкового) періоду (рядок 14.1 + рядок 14.2)</td>
  ...
  <table class="table-main borderred">
    ...
    <tr>
      <td class=" col75" colspan="3">Зменшення суми, яка підлягала перерахуванню до бюджету<br/>(рядок 16 – рядок 15, якщо рядок 16 < рядка 15)</td>
      <td class=" text-center text-big">18</td>
      <td class=" text-center">{{R018G3}}</td>
    </tr>
    <tr>
      <td class=" col75" colspan="3">Сума штрафу, яка нарахована платником податку самостійно у зв’язку з виправленням помилки, {{R019G1}} %<br/>(рядок 17 × 3 % або 17 × 5 %)</td>
      <td class=" text-center text-big">19</td>
      <td class=" text-center">{{R019G3}}</td>
    </tr>
    <tr>
      <td class=" col75" colspan="3">Сума пені, яка нарахована платником податку самостійно відповідно до підпункту 129.1.3 пункту 129.1 статті 129.1 статті 129 глави 12 розділу ІІ Податкового кодексу України</td>
  ...
  <h6 class="font-caption">
    VIII. Визначення податкових зобов'язань по військовому збору
  </h6>
  ...
  <table class="table-main" style="margin-top: 0;">
    <tr class="borderred" style="border-top: 0 !important;">
      ...
      <td class=" text-center" style=" border-top: 0;">Обсяг (грн, коп)</td>
    </tr>
    <tr class="borderred">
  ...
  <table class="table-main borderred" style="margin-top: 2px;">
    ...
    <tr>
      <td class=" col75">Зменшення суми військового збору, яка підлягала перерахуванню до бюджету<br/>(рядок 27 – рядок 26, якщо рядок 27 < рядка 26)</td>
  ...
  <table class="table-main borderred">
    <tr>
      ...
      <td class="borderred text-big">Додаток 1 "Відомості про суми нарахованого доходу застрахованих осіб та суми нарахованого єдиного внеску"</td>
      <td class="borderred text-big col10">{{HD1}}</td>
    </tr>
     <tr>
      <td class="borderred table-first-cell text-big">2</td>
      <td class="borderred text-big">Додаток 2 "Розрахунок загального мінімального податкового зобов’язання за податковий (звітний) рік"</td>
    ...
    <tr>
      <td style="padding: 0;">
        <table class="table-inner">
          ...
          <tr>
            <td rowspan="2" style="border: 0;">Реєстраційний номер облікової картки платника податків або серія (за наявності) та номер паспорта</td>
